...
BUYBACK_DATA_TOOL$Industry_name <- as.character(BUYBACK_DATA_TOOL$Industry_name)
...
fluidPage(shiny::actionButton("computeButton","Update Results",icon=icon("spinner")) )
```
<br>

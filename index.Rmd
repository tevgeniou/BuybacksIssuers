...
**Note that it takes a few minutes (possibly more than five) to compile the new paper. Please wait until the option to download the paper, becomes available.**


```{r, fig.width=6, fig.height=5,echo=FALSE}
useShinyjs(rmd=TRUE)
fluidPage(
  shiny::actionButton("compileReport","Compile Paper",icon=icon("spinner")),
  shiny::downloadButton("downloadReport", "Download Paper")
)

...
# load("../FinanceData/created_projects_datasets/BUYBACKS.Rdata") # GENERATED BY create_bbissuers_data.R
# "../FinanceData/rawdata_stambaugh_mispricing_index/Stambaugh_Mispricing_Score.csv" # from http://www.saif.sjtu.edu.cn/facultylist/yyuan/Misp_Score.csv
...
if (0){ # This is slow
  ...
  save(StambaughBB,StambaughISS, StambaughBB_lastmonth, StambaughISS_lastmonth, file = "../FinanceData/created_projects_datasets/StambaughBUYBACKS.Rdata")
} else {
  load("../FinanceData/created_projects_datasets/StambaughBUYBACKS.Rdata")
...
if (1){ # Mispricing factors
  misprice_factors <- read.csv("../FinanceData/rawdata_indices_and_factors/M4.csv", sep=",", dec=".")
...
if (0){ # q-factors test
  qfactors <- read.csv("../FinanceData/rawdata_indices_and_factors/qfactors.csv", sep=";", dec=".")
...
if (0){
  ...
  save(Institutional,Institutional.number, file = "../FinanceData/created_projects_datasets/Buybacks.Institutional.number.Rdata")
} else {
  load("../FinanceData/created_projects_datasets/Buybacks.Institutional.number.Rdata")
}

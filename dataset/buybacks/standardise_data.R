#standardizes the SDC data
datasetname="buybacks"

################################################################
# INPUT FILES
################################################################
# Uses the input and output files from 'dataset/buybacks/sdc/buybacks_rawdata_combine.R'

################################################################
# OUTPUT FILE
################################################################
# The usual file where all the data will be finally saved, after augmenting them at each step
...
source('dataset/buybacks/sdc/buybacks_rawdata_combine.R')
SDC <- all_buybacks
rm("all_buybacks")

################################################################
### SOME IMMEDIATE DATA CLEAN FOR THIS SPECIFIC PROJECT
################################################################
...
cleanup$Standardise$DUPLICATE_EVENTS_REMOVED = DUPLICATE_EVENTS_REMOVED 

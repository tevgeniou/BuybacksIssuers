...
file_in_repurchases_dataset  = "dataset/buybacks/sdc/sdc_output_buybacks_repurchases.csv"
file_in_MnA_dataset  = "dataset/buybacks/sdc/sdc_output_buybacks_ma.csv"
...
file_out_for_standardize_data  = "dataset/buybacks/sdc/sdc_output_buybacks.csv"
#all_buybacks_orig <- read.csv(file_out_for_standardize_data,header=T,stringsAsFactors = F,sep=",")


################################################################

buybacks_repurchases <- read.csv(file_in_repurchases_dataset,header=T,stringsAsFactors = F,sep=";")
buybacks_ma <- read.csv(file_in_MnA_dataset,header=T,stringsAsFactors = F,sep=";")

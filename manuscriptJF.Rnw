...
\paragraph{Theodoros Evgeniou} I have nothing to disclose.
\paragraph{Enric Junqu\'e de Fortuny}  I have nothing to disclose.
\paragraph{Nick Nassuphis}  I have nothing to disclose.
\paragraph{Theo Vermaelen}  I have nothing to disclose.
...
par(mfrow=c(2,2), mar=c(2.7,4,2.7,4))
